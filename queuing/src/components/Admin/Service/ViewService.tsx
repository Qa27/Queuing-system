  ...
  return (
    <div>
      <Layout>
        ...
        <RBreadcrumb />
        <Content>
          <span className="V_title">Service management</span>
          <div className="VS_box_left">
            <span className="V_table_title">Information services</span>
            <div
              className="V_col1"
            >
              <span>
                Service code: <span>{idS}</span>
              </span>
              <span>
                Service name: <span>{nameS}</span>
              </span>
              <span>
                Discription: <span>{descriptionS}</span>
              </span>
            </div>
            <span className="V_table_title">Rules for getting tickets</span>
            <div
              className="V_col1"
            >
              {autoS ? (
                <div style={{ display: "flex" }}>
                  ...
                  <InputNumber
                    ...
                    disabled={true}
                  />
                  <span style={{ position: "absolute", marginLeft: "296px" }}>
                    to
                  </span>
                  <InputNumber
                    className="V_numS2"
              ...
              {resetS ? (
                <span style={{ marginTop: "22px" }}>Reset every day</span>
              ) : null}
            </div>
          </div>
          <div className="VS_box_option">
            <section className="section_content">
              <Link to={`/list_service/${id}`} className="V_addS">
                <UpdIcon />
